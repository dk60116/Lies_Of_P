// ClientC.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//
...
#define _CRTDBG_MAP_ALLOC
    ...
    LoadStringW(hInstance, IDC_CLIENTC, szWindowClass, MAX_LOADSTRING);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_CLIENTC));
