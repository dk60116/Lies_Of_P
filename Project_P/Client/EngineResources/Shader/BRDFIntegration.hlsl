// BRDFIntegration.hlsl
// Generates Split-Sum BRDF LUT (256x256, R16G16_FLOAT)
// U = NdotV, V = roughness -> output (scale, bias)
...
{
    VSOut o;
    o.posH = float4(v.posL.xy * 2.0 - 1.0, 0.5, 1.0);
    o.posH.y = -o.posH.y;
    o.uv = v.uv;
    return o;
}
...
{
    float NdotV    = max(i.uv.x, 0.001);
    float roughness = max(i.uv.y, 0.001);
